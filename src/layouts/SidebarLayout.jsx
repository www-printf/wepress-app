...
const SidebarLayout = ({ children }) => {
    ...
    const customTheme = {
        root: {
            inner: "h-full overflow-y-auto overflow-x-hidden bg-white dark:bg-gray-800 px-3 py-4 border-[#cfd2d7] border-2"
        }
    };
                        ...
                        >
                            <Sidebar.Items>
                                <Sidebar.ItemGroup>
                                    ...
                                    <Sidebar.Item
                                        href={ENDPOINTS.WEPRESS_LIBRARY}
                                        icon={HiInbox}
                                        active={location.pathname === ENDPOINTS.WEPRESS_LIBRARY}
                                    ...
                                    <Sidebar.Item
                                        href={ENDPOINTS.SHARED_WITH_ME}
                                        icon={() => <img src={icon_share} alt="icon_share" />}
                                        active={location.pathname === ENDPOINTS.SHARED_WITH_ME}
                                        className="justify-start"
                                    >
                                    ...
                                    <Sidebar.Item
                                        href={ENDPOINTS.MY_DOCUMENTS}
                                        icon={() => <img src={icon_people} alt="icon_people" />}
                                        active={location.pathname === ENDPOINTS.MY_DOCUMENTS}
                                        className="justify-start"
                                    >
