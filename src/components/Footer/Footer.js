  ...
  return (
    <footer className="bg-blue-700 text-white p-4 ">
      <div className="flex justify-center items-center space-x-10">
        <div className="hidden md:block border-t border-white w-1/4"></div>
        <div className="flex items-center space-x-6">
          <a href="https://github.com" className="text-3xl">
            <img src={ico_git} className="h-10 w-10" />
            <i className="fab fa-github"></i>
          </a>
          <a href="https://www.figma.com" className="text-3xl">
            <img src={ico_figma} className="h-10 w-10" />
            <i className="fab fa-figma"></i>
          </a>
          <a href="mailto:contact@wepress.com" className="text-3xl">
            <img src={ico_mail} className="h-10 w-10" />
