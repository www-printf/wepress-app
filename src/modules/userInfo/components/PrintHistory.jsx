  ...
  return (
    <section className="flex flex-col items-center px-2.5 pt-2.5 pb-5 bg-white rounded-xl border border-solid border-zinc-200 min-w-[240px] w-[625px] max-md:max-w-full">
      ...
      <button className="flex gap-2.5 justify-center items-center p-2.5 mt-2.5 text-sm font-semibold tracking-tight text-center bg-white rounded-lg border border-solid border-zinc-200 text-zinc-800">
        <img
          loading="lazy"
          src="https://cdn.builder.io/api/v1/image/assets/TEMP/1d0a0398122e8e11fecc7e2fe8e55b12a4a77fbfd586ae0cd71052c8a27b94e8?placeholderIfAbsent=true&apiKey=2e91b678645640cfb9bdb9d816fad104"
          alt=""
          className="object-contain shrink-0 self-stretch my-auto w-5 aspect-square"
        />
