...
const AboutServices = () => {
    ...
    return (
      <div className="bg-gray-100 h-[1400px] min-h-screen">
        <div className="bg-blue-900 h-screen flex flex-row px-6 items-center justify-center">
          <div className="w-full flex flex-col justify-center items-center">
            <img src={logo} alt="" className="w-1/2"/>
            <p className="w-3/4 text-center text-white text-2xl">Dịch vụ in tài liệu tiện lợi, nhanh chóng dành riêng cho sinh viên Đại học Bách Khoa TP.HCM!</p>
          </div>
          <div className="w-fit">
        ...
        <div className="max-w-6xl mx-auto text-center p-6 h-screen ">
          ...
          Nâng cao hiệu quả học tập của bạn với dịch vụ in ấn tiên tiến của chúng tôi. </p>
