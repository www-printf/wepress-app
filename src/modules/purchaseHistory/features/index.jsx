...
const TransactionHistory = () => {
  ...
  return (
    <div className="bg-gray-100 h-auto min-h-[1000px]">
      <div className="p-6 max-w-4xl mx-auto">
        ...
        <div className="bg-white p-4 shadow-lg rounded-lg mb-6">
          <h2 className="text-lg font-semibold mb-4 border-b-2 border-black">
            Lịch sử giao dịch
          </h2>
          <div className="flex items-center space-x-4">
            ...
            <div>
              <button
                className="flex w-[120px] px-4 py-2 border rounded-md text-white bg-blue-600 hover:bg-blue-700 active:bg-blue-800 font-semibold transition"
                onClick={handleSearch}
              >
                <img
                  src={icon_filter}
                  className="w-[20px] h-[20px] mr-2 invert"
                ></img>
                Tra cứu
              </button>
            </div>
          ...
          {filteredTransactions.length === 0 && startDate && endDate ? (
            ...
            <ul>
              {displayedTransactions
                .slice(0, showAll ? displayedTransactions.length : 10)
                .map((transaction) => (
                    ...
                    <p>
                      ...
                      <div className="flex justify-between">
                        <span className="font-semibold">
                          [{transaction.id}] - [{transaction.bank}] - [
                          {transaction.account}] - {transaction.content}
                        </span>
