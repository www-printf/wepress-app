...
const PrintHistoryRow = ({ id, printerId, documentName, paperSize, pageCount, printDate, status }) => {
  ...
  return (
    <div className="flex items-center bg-white border-b border-zinc-200">
      <div className="p-2.5 w-[150px]">{id}</div>
      <div className="p-2.5 w-[150px]">{printerId}</div>
      <div className="p-2.5 w-[350px]">{documentName}</div>
      <div className="p-2.5 w-[150px]">{paperSize}</div>
      <div className="p-2.5 w-[120px]">{pageCount}</div>
      <div className="p-2.5 w-[120px]">{printDate}</div>
      <div className="flex items-center gap-2.5 p-2.5 w-[150px]">
        <img
          loading="lazy"
          src={statusInfo.icon}
          ...
          alt="Status icon"
        />
        <div className={`text-xs font-semibold ${statusInfo.className}`}>{statusInfo.text}</div>
      </div>
    </div>
  );
};
